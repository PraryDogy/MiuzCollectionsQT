...
from .scaner_utils_new import (DbUpdater, DirsCompator, DirsLoader,
                               DirsUpdater, HashdirUpdater, ImgCompator,
                               ImgLoader, Inspector, MainFolderRemover)
...
"""
Не удаляй сканер ниже
Он об-одит всегда все изображения, возможно он более надежен
"""
