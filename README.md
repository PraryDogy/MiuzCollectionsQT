...
Мы обнаружили массовое удаление изображений.
Нажмите "разрешить", чтобы подтвердить это.
Если вы не удаляли изображения, укажите правильный путь
к каталогу изображений.
